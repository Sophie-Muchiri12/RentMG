...
INSTALLED_APPS = [
    ...
    'corsheaders',  # For handling CORS with mobile apps
    
    # Your app
    'renttrack',  # Replace with your app name
]
...
# Custom User Model
AUTH_USER_MODEL = 'renttrack.User'  # Replace 'renttrack' with your app name
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'renttrack_db'),
        'USER': os.getenv('DB_USER', 'renttrack_user'),
